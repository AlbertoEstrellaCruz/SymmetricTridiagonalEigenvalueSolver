...
__device__ void zerodandc_n_cu( double *delta, double *plambda, double *dmlambda, double *d, double *v2, int i, int n, double eps )
{
	int max_iter;
	int n_iter;
	int j;
...
__global__ void solve_secular_cu( double *delta, double *lambda, double *dmlambda, double *d, double *v2, int n, double eps )
{
	...
	{
		zerodandc_n_cu( delta + i * n, lambda + i, dmlambda + i * n, d, v2, i, n, eps );
